# Theme Colors
theme_colors = {
    'primary': '#7eb4ea',  # Sky Blue
    'secondary': '#5c85ad',  # Darker Blue for contrast
    'background': '#f4f7fa',  # Light background shade
    'accent': '#4a90e2',  # Brighter Accent Blue
    'text': '#333333',  # Dark grey for text
    'success': '#5cb85c',  # Success green
    'error': '#d9534f',  # Error red
    'info': '#5bc0de'  # Light information blue
}
...
navigation_style = {
    'padding': '20px 15px',
    'backgroundImage': 'linear-gradient(to right, #7eb4ea 0%, #5c85ad 100%)',
    'fontSize': '18px',
    'textAlign': 'center',
    'fontWeight': 'bold',
    'color': 'white',
